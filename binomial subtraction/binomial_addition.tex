...
\begin{lstlisting}
https://github.com/Debolena/AI5002-Probability-and-Random-Variables/blob/main/binomial%20subtraction/binomial%20.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/Debolena/AI5002-Probability-and-Random-Variables/blob/main/binomial%20subtraction/binomial_addition.tex
\end{lstlisting}
\section{Problem}
Find the PMF of the addition of two binomial random variables.
\section{Solution}
